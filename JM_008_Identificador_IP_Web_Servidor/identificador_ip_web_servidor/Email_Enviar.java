...
public class Email_Enviar {
    ...
    String ip;
    Identificador_Ip_Web_Servidor_Submenu_01 Leitor_De_Email_Submenu_01;
    
    public Email_Enviar( List<String> list_cmd2, List<File> fileMails2, String ip2, Identificador_Ip_Web_Servidor_Submenu_01 Leitor_De_Email_Submenu_012 ) {
