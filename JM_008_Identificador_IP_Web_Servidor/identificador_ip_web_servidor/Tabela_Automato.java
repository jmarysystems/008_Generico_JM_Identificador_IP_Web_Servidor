...
public class Tabela_Automato extends javax.swing.JPanel {   
     ...
     * @param Home2 */
    public Tabela_Automato( Home Home2 ) {
        initComponents();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////             
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Tabela Extrator de Emails - JMarySystems");
        ...
        jTabbedPane1.addTab("Emails_Extraidos", Pergunta);
                    ...
                    switch( C_i ){
                        ...
                        case 9: 
                            try{
                                ...
                                UsuarioSistema UsuarioSistema2 = new UsuarioSistema();
                                String x = str.replace(".", "");
                                String x2 = x.replace(",", ".");
                                int idCadastroUsuario = 0; try{ idCadastroUsuario = Integer.parseInt(x2); } catch( Exception e ){}
...
/////// VERIFICANDO REPETIÇÃO - CÓDIGO AUXILIAR /////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    for (UsuarioSistema list1 : list) {
                        ...
                        if (list1.getCodigoAuxiliar().equals( UsuarioSistema.getCodigoAuxiliar() )) {
                            ...
                            //System.out.println( "Material Já Cadastrado - " + UsuarioSistema.getCodigoAuxiliar() );
        ...
        try{
            ...
            switch(opcao){
                ...
                case 1:
                    ...
                    tbPesquisa.getColumnModel().getColumn(count).setPreferredWidth(300);
                    tbPesquisa.getColumnModel().getColumn(count).setResizable(true);
                    tbPesquisa.getColumnModel().getColumn(count).setCellRenderer( rendererCentro );
                    count++;
